...
import 'package:ecommerce_project/navigator/search.dart';
import 'package:ecommerce_project/ui/product_details.dart';
                          ...
                          child: Column(
                            children: [
                              AspectRatio(
                                aspectRatio: 2,
                                child: Image.network(
                                    _products[index]["p_image"][0]),
                              ),
                              Text("${_products[index]["p_name"]}"),
                              Text(
                                  "\৳  ${_products[index]["p_price"].toString()}"),
                            ],
                          ),
                        ),
                      );
